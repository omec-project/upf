...
def get_inet_sequpdate_args(max_session):
    kwargs = {"fields": [
        {'offset': 30, 'size': 4, 'min': 0x10000001,
         'max': 0x10000001+max_session-1}]}
    return kwargs
...
def get_ue_sequpdate_args(max_session):
    kwargs = {"fields": [
        {'offset': 46, 'size': 4, 'min': 0xf0000000,
         'max': 0xf0000000+max_session-1},
        {'offset': 62, 'size': 4, 'min': 0x10000001,
         'max': 0x10000001+max_session-1}]}
    return kwargs
