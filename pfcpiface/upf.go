...
func (u *upf) sendMsgToUPF(method string, pdrs []pdr, fars []far) uint8 {
	return u.intf.sendMsgToUPF(u, method, pdrs, fars)
}

func sendDeleteAllSessionsMsgtoUPF(u *upf) {
	u.intf.sendDeleteAllSessionsMsgtoUPF(u)
}

func (u *upf) handleChannelStatus() bool {
	return u.intf.handleChannelStatus(u)
}
