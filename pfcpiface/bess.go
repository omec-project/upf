...
func (b *bess) handleChannelStatus(u *upf) bool {
	return false
}

func (b *bess) sendMsgToUPF(u *upf, method string, pdrs []pdr, fars []far) uint8 {
	// create context
...
func (b *bess) sendDeleteAllSessionsMsgtoUPF(u *upf) {
