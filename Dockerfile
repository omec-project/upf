...
FROM ghcr.io/omec-project/bess_build:260409@sha256:9170b9f29eecfa8689752a5bd657be0d3967e7b330c1934a1e18f0b5490b11dd AS bess-build
...
FROM golang:1.26.2-bookworm@sha256:4f4ab2c90005e7e63cb631f0b4427f05422f241622ee3ec4727cc5febbf83e34 AS protoc-gen
...
FROM golang:1.26.2-bookworm@sha256:4f4ab2c90005e7e63cb631f0b4427f05422f241622ee3ec4727cc5febbf83e34 AS pfcpiface-build
ARG GOFLAGS
WORKDIR /pfcpiface
